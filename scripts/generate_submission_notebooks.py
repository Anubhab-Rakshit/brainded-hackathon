...
cograd_cells = [
    ...
    markdown_cell("## 3. Training Pipeline Verification\nThis section demonstrates the full training loop used to train the model. \n**Note:** The full training dataset (MIMIC-CXR + NIH) is approximately **30GB**. For this Colab demonstration, we execute the training pipeline on a **subset** of data to verify the architecture and loss convergence."),
